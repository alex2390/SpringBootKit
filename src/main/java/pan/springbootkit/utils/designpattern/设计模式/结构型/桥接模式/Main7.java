...
import pan.springbootkit.utils.designpattern.设计模式.结构型.桥接模式.AreaA.AreaA;
import pan.springbootkit.utils.designpattern.设计模式.结构型.桥接模式.AreaA.AreaA2;
import pan.springbootkit.utils.designpattern.设计模式.结构型.桥接模式.AreaB.AreaB3;
